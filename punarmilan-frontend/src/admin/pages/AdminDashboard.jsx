...
import { CheckCircle, Users, Activity, BarChart3, TrendingUp, PieChart, Flag, Bell } from 'lucide-react';
import {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-8 rounded-[32px] shadow-sm border border-gray-100">
                    ...
                    <div className="space-y-4">
                        {[
                            { title: 'New Profile Verification', count: stats?.pendingApprovals || 0, color: 'text-amber-500 bg-amber-50' },
                            { title: 'Pending Photo Moderation', count: stats?.pendingPhotoApprovals || 0, color: 'text-blue-500 bg-blue-50' },
                            { title: 'New User Reports', count: stats?.reportedProfiles || 0, color: 'text-rose-500 bg-rose-50' }
                        ].map((action, i) => (
