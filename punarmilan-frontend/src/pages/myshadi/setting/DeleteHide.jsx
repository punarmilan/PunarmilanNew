        ...
        <div className="w-full space-y-8">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Control your presence on PunarMilan</p>
                </div>
                {lastSaved && (
            ...
            {/* Visibility Card */}
            <div className={`group relative bg-white border-2 rounded-[2rem] p-6 md:p-8 transition-all duration-500 ${currentVisibility === "hidden" ? 'border-orange-200 bg-orange-50/20' : 'border-gray-50'}`}>
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div className="flex gap-5 flex-1 max-w-2xl">
                        <div className={`w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 transition-all duration-500 ${currentVisibility === "hidden" ? 'bg-orange-500 text-white shadow-lg shadow-orange-100' : 'bg-pink-50 text-pink-500'}`}>
            ...
            {/* Deletion Card */}
            <div className="relative overflow-hidden bg-white border-2 border-gray-50 rounded-[2rem] p-6 md:p-8 hover:border-red-100 transition-all duration-300">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div className="flex gap-5 flex-1 max-w-2xl">
                    ...
                    {!showDeleteConfirm ? (
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto animate-in zoom-in-95 duration-200">
                            <button
                                ...
                                className="w-full sm:w-auto px-6 py-4 rounded-2xl font-bold text-gray-500 bg-gray-50 hover:bg-gray-100 transition-all"
                            >
                                Cancel
                            </button>
                            <button
