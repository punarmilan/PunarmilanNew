                    ...
                    <nav className="flex flex-wrap justify-center gap-3 mb-8">
                        {navItems.map((item) => (
                            <Link
                                key={item.name}
                                to={item.href}
                                className="px-4 py-2 rounded-full border border-white/5 bg-white/[0.02] backdrop-blur-md hover:bg-white/10 hover:border-[#ff2d7a]/30 text-white/80 hover:text-white text-xs font-bold transition-all duration-300 hover:scale-105 shadow-sm hover:shadow-[0_0_10px_rgba(255,45,122,0.15)]"
                            >
                                {item.name}
                            </Link>
                        ))}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        {featureCards.map((card, idx) => (
                            <Link
                                key={idx}
                                to={card.href}
                                className="group relative flex flex-row items-center gap-3.5 p-3 rounded-xl bg-white/[0.02] border border-white/5 hover:border-[#ff2d7a]/30 hover:bg-white/[0.05] transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-gray-400 text-[10px] leading-tight mt-0.5 line-clamp-1">
                                        {card.desc}
                                    </p>
                                </div>
                            </Link>
